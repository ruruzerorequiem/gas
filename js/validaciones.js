  ...
  if (formRegistro) {
    formRegistro.addEventListener('submit', async (e) => {
      ...
      if (esValido) {
        ...
        const alertaError = document.getElementById('mensajeErrorRegistro');

        if (resp.estado === 'OK') {
          if (alertaError) alertaError.classList.add('d-none');
          if (alertaExito) {
            alertaExito.textContent = resp.mensaje;
          ...
          if (alertaError) {
            alertaError.textContent = resp.mensaje;
  ...
  if (formLogin) {
    formLogin.addEventListener('submit', async (e) => {
      ...
      if (esValido) {
        ...
        const alertaExito = document.getElementById('mensajeExitoLogin');
        const alertaError = document.getElementById('mensajeErrorLogin');
        ...
        if (resp.estado === 'OK') {
          ...
          if (typeof actualizarEstadoSesionUI === 'function') {
